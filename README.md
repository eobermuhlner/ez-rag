...
# Supported file types: .txt, .pdf, .md, .html / .htm, .csv, .rtf, .docx, .doc, .xlsx, .xls, .pptx, .ppt, .xml, .svg, .rss, .atom, .xhtml, .json, .jsonl, .jsonc, .kt, .kts, .java, .ts, .tsx, .js, .jsx
...
| `ingest <file\|dir>`           | Ingest files or directories (recursive) into the vector store. Supports `.txt`, `.pdf`, `.md`, `.html`/`.htm`, `.csv`, `.rtf`, `.docx`, `.doc`, `.xlsx`, `.xls`, `.pptx`, `.ppt`, `.xml`, `.svg`, `.rss`, `.atom`, `.xhtml`, `.json`, `.jsonl`, `.jsonc`, `.kt`, `.kts`, `.java`, `.ts`, `.tsx`, `.js`, `.jsx`. Prints each file as it is ingested. |
...
Ingest files or directories into the vector store. Supported file types: `.txt`, `.pdf`, `.md`, `.html`/`.htm`, `.csv`, `.rtf`, `.docx`, `.doc`, `.xlsx`, `.xls`, `.pptx`, `.ppt`, `.xml`, `.svg`, `.rss`, `.atom`, `.xhtml`, `.json`, `.jsonl`, `.jsonc`, `.kt`, `.kts`, `.java`, `.ts`, `.tsx`, `.js`, `.jsx`.
...
- Any file type accepted by `ingest`: `.txt`, `.pdf`, `.md`, `.html`/`.htm`, `.csv`, `.rtf`, `.docx`, `.doc`, `.xlsx`, `.xls`, `.pptx`, `.ppt`, `.xml`, `.svg`, `.rss`, `.atom`, `.xhtml`, `.json`, `.jsonl`, `.jsonc`, `.kt`, `.kts`, `.java`, `.ts`, `.tsx`, `.js`, `.jsx`
