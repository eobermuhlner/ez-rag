...
# Supported file types: .txt, .pdf, .md, .adoc, .asciidoc, .rst, .html / .htm, .csv, .rtf, .docx, .doc, .xlsx, .xls, .pptx, .ppt, .xml, .svg, .rss, .atom, .xhtml, .json, .jsonl, .jsonc, .kt, .kts, .java, .ts, .tsx, .js, .jsx
...
| `ingest <file\|dir>`           | Ingest files or directories (recursive) into the vector store. Supports `.txt`, `.pdf`, `.md`, `.adoc`, `.asciidoc`, `.rst`, `.html`/`.htm`, `.csv`, `.rtf`, `.docx`, `.doc`, `.xlsx`, `.xls`, `.pptx`, `.ppt`, `.xml`, `.svg`, `.rss`, `.atom`, `.xhtml`, `.json`, `.jsonl`, `.jsonc`, `.kt`, `.kts`, `.java`, `.ts`, `.tsx`, `.js`, `.jsx`. Prints each file as it is ingested. |
...
Ingest files or directories into the vector store. Supported file types: `.txt`, `.pdf`, `.md`, `.adoc`, `.asciidoc`, `.rst`, `.html`/`.htm`, `.csv`, `.rtf`, `.docx`, `.doc`, `.xlsx`, `.xls`, `.pptx`, `.ppt`, `.xml`, `.svg`, `.rss`, `.atom`, `.xhtml`, `.json`, `.jsonl`, `.jsonc`, `.kt`, `.kts`, `.java`, `.ts`, `.tsx`, `.js`, `.jsx`.

Source code files (`.kt`, `.kts`, `.java`, `.ts`, `.tsx`, `.js`, `.jsx`) are parsed with a tree-sitter AST and chunked at structural boundaries — class declarations, methods, functions, and constructors — so that each retrieved chunk corresponds to a coherent, self-contained unit of code. Package declarations and imports are included in every chunk. All other file types fall through to plain-text ingestion.
...
- Any file type accepted by `ingest`: `.txt`, `.pdf`, `.md`, `.adoc`, `.asciidoc`, `.rst`, `.html`/`.htm`, `.csv`, `.rtf`, `.docx`, `.doc`, `.xlsx`, `.xls`, `.pptx`, `.ppt`, `.xml`, `.svg`, `.rss`, `.atom`, `.xhtml`, `.json`, `.jsonl`, `.jsonc`, `.kt`, `.kts`, `.java`, `.ts`, `.tsx`, `.js`, `.jsx`
