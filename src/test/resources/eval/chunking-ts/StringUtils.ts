...
export class StringUtils {
     ...
     * @returns the truncated string with ellipsis if shortened, or the original string if it fits
     */
     ...
     * @returns the left-padded string of the specified width
     */
    padLeft(text: string, width: number, padChar: string = " "): string {
     ...
     * @returns the number of words found in the input string
     */
